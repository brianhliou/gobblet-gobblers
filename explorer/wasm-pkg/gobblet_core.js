...
export class WasmBoard {
     ...
     * @param {number} to_row
     * @param {number} to_col
     * @param {number | null} [from_row]
     * @param {number | null} [from_col]
     * @param {number | null} [size]
     * @returns {boolean}
     */
    applyMove(to_row, to_col, from_row, from_col, size) {
        const ret = wasm.wasmboard_applyMove(this.__wbg_ptr, to_row, to_col, isLikeNone(from_row) ? 0xFFFFFF : from_row, isLikeNone(from_col) ? 0xFFFFFF : from_col, isLikeNone(size) ? 0xFFFFFF : size);
        return ret !== 0;
    }
    /**
     ...
     */
    cellStack(row, col) {
        const ret = wasm.wasmboard_cellStack(this.__wbg_ptr, row, col);
     ...
     */
    clone() {
        const ret = wasm.wasmboard_clone(this.__wbg_ptr);
     ...
     */
    legalMoves() {
        const ret = wasm.wasmboard_legalMoves(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    checkWinner() {
        const ret = wasm.wasmboard_checkWinner(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    isGameOver() {
        const ret = wasm.wasmboard_isGameOver(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    winningLine() {
        const ret = wasm.wasmboard_winningLine(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
     ...
     */
    currentPlayer() {
        const ret = wasm.wasmboard_currentPlayer(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    toU64() {
        const ret = wasm.wasmboard_toU64(this.__wbg_ptr);
     ...
     */
    static fromU64(bits) {
        const ret = wasm.wasmboard_fromU64(bits);
        return WasmBoard.__wrap(ret);
    }
    /**
     ...
     */
    reserves(player) {
        const ret = wasm.wasmboard_reserves(this.__wbg_ptr, player);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
     ...
     */
    canonical() {
        const ret = wasm.wasmboard_canonical(this.__wbg_ptr);
        return BigInt.asUintN(64, ret);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('gobblet_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
